...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO customerreg (Customer_Name, email, mobile, Password, Address) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $customerName, $email, $mobile, $password, $address);
